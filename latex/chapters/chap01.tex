...
As we explore the different dimensions of data, it is essential to understand the fundamental types of data, their characteristics, and how they influence decision-making and innovation. The following sections will delve into the classification of data types, the economic significance of data, and the evolving landscape of private data utilization in an increasingly interconnected world.
...
This thesis is organized to provide a clear and comprehensive exploration of the research topic. The structure is as follows:
\begin{itemize}
    \item \textbf{Abstract:} A concise summary of the thesis, outlining the research objectives, methodology, key findings, and conclusions. (This section is not assigned a chapter number.)
    \item \textbf{Chapter 1: Introduction.} Introduces the role of data in modern technologies, reviews the evolution of web scraping, and discusses the challenges associated with these topics.
    \item \textbf{Chapter 2: Methods and Procedures.} Details the methodologies employed, including neural network architectures, recurrent models, and parameter optimization techniques used for data extraction.
    \item \textbf{Chapter 3: Benchmarks and Comparisons.} Provides a comparative analysis between traditional web scraping techniques and the proposed approach using large language models, featuring performance metrics and scalability assessments.
    \item \textbf{Chapter 4: Conclusions and Future Work.} Summarizes the research outcomes, discusses their implications, and outlines potential directions for future research and industrial applications.
    \item \textbf{Appendices and Bibliography:} Supplementary materials, datasets, and references are provided for further reading and to support the research findings.
\end{itemize}

\noindent\textbf{Note of the author:} This thesis leverages large language models---including OpenAI's ChatGPT---to enhance text quality, source the latest studies, and correct grammatical errors.
...
\subsection{Introduction to 20 and limits of RNN}
...
As can be see in figure ~\ref{fig:20_cell}, the cell works exactly like a classic cell, except that the state is split into 2 vectors: ${\bf h}_{(t)}$ and ${\bf c}_{(t)}$, which represent respectively the short term state and the long term state.
\begin{itemize}
...
Incorporating asynchronous processing into short-term memory enhances an agent’s ability to respond to real-time changes. According to \cite{10}, "giving agents the ability to manage multiple concurrent processes in real-time and asynchronously respond to the user as soon as any process finishes will significantly reduce perceived delay and meaningfully improve user experience." This approach ensures that agents do not remain idle while waiting for new inputs but can instead process multiple stimuli simultaneously, improving adaptability in dynamic systems.
...
\chapter{Scrapegraph's architecture}
...
In the following sections, we will delve into the structural components of the library, exploring the key nodes that drive its functionality and the principal graphs that enable complex scraping workflows.
...
\begin{tabular}{|l|c|c|}
\hline
\textbf{Source}              & \textbf{Frequency} & \textbf{Percentage} \\ \hline
linkedin.com                 & 18,914             & 10.34\% \\ \hline
profesia.sk                  & 16,753             & 9.16\% \\ \hline
adidas.se                    & 14,771             & 8.07\% \\ \hline
localhost:8000               & 14,384             & 7.86\% \\ \hline
m.stock.naver.com            & 13,508             & 7.38\% \\ \hline
nytimes.com                  & 12,532             & 6.85\% \\ \hline
google.com                   & 10,211             & 5.58\% \\ \hline
baike.baidu.com              & 9,970              & 5.45\% \\ \hline
derstandard.at               & 9,865              & 5.40\% \\ \hline
ndtvprofit.com               & 9,809              & 5.37\% \\ \hline
faz.net                      & 9,587              & 5.24\% \\ \hline
livemint.com                 & 9,110              & 4.98\% \\ \hline
naturitas.es                 & 8,587              & 4.70\% \\ \hline
web.archive.org              & 8,022              & 4.39\% \\ \hline
r.jina.ai                    & 7,764              & 4.25\% \\ \hline
\textbf{Other}               & 29,216             & 16.00\% \\ \hline
\textbf{Total}               & 182,003            & 100.00\% \\ \hline
\end{tabular}
\caption{Top 15 most frequently visited websites as of January 24, 2025, including an 'Other' category and total.}
...
\section{LLM-Based Extraction Benchmarking}
...
\setlength{\tabcolsep}{10pt} % Aumenta la spaziatura tra le colonne
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Sito} & \textbf{Wired.com} & \textbf{Walmart.com} & \textbf{Ikea.com} & \textbf{Nature.com} \\ \hline
\textbf{ScrapeGraphAI APIs} & 20.0 s & 27.99 s & 27.56 s & 16.86 s \\ \hline
\end{tabular}
...
\begin{figure}[h!]
    \centering
    \rotatebox{270}{ % Ruota l'immagine di 90 gradi (modifica l'angolo se necessario)
        \includegraphics[width=1.5\linewidth]{Assets/growing_companies.png}
    }
